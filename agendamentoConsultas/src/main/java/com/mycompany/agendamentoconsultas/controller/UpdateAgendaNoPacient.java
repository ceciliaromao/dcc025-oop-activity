 ...
 * @author Fernando
 */
public class UpdateAgendaNoPacient implements WindowListener {
    private static final String PATH = "agenda.json";
    private final AgendaNoPacientScreenView screenView;
    
    public UpdateAgendaNoPacient(AgendaNoPacientScreenView screenView) {
