...
import com.mycompany.agendamentoconsultas.controller.AuthAdmin;
 ...
 * 
 */
public class AdminLoginScreenView implements ActionListener {
    ...
    public AdminLoginScreenView(ScreenView screenView) {
    ...
    private void createLogin(){
        ...
        btnEntrar.addActionListener(new AuthAdmin(this));
